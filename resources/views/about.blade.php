...
<head>
    ...
    <title>Tentang Kami - BudgetBite</title>
...
<body class="bg-surface text-on-surface font-body-md text-body-md antialiased pt-16 min-h-screen flex flex-col">
    ...
    <main class="w-full flex-grow">
        <section class="max-w-container-max mx-auto px-gutter py-xl mt-10">
            <h1 class="font-display-lg text-display-lg text-on-surface mb-md">Tentang Kami</h1>
            <div class="bg-white/70 backdrop-blur-lg border border-surface-variant rounded-xl p-md shadow-sm prose max-w-none">
                <p class="font-body-lg text-body-lg text-on-surface-variant mb-6">BudgetBite didirikan dengan satu misi utama: Membantu keluarga Indonesia menyajikan hidangan lezat dan bergizi tanpa harus melebihi anggaran bulanan.</p>
                <p class="font-body-md text-body-md text-on-surface mb-4">Kami percaya bahwa makanan enak tidak harus mahal. Dengan sistem perhitungan biaya cerdas yang kami miliki, Anda dapat dengan mudah mencari resep-resep terbaik berdasarkan batas budget yang Anda miliki saat ini.</p>
                <p class="font-body-md text-body-md text-on-surface mb-4">Setiap resep di BudgetBite dikurasi dan disesuaikan dengan harga bahan pokok rata-rata di pasaran, sehingga estimasi biaya yang ditampilkan relevan dan akurat.</p>
                <div class="mt-8">
                    <h2 class="font-headline-md text-headline-md text-primary mb-4">Visi Kami</h2>
                    <p class="font-body-md text-body-md text-on-surface">Menjadi asisten dapur terpercaya bagi setiap rumah tangga dalam merencanakan menu harian yang lezat, sehat, dan ekonomis.</p>
                </div>
            </div>
        </section>
    </main>
