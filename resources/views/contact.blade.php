...
<head>
    ...
    <title>Hubungi Kami - BudgetBite</title>
...
<body class="bg-surface text-on-surface font-body-md text-body-md antialiased pt-16 min-h-screen flex flex-col">
    ...
    <main class="w-full flex-grow">
        <section class="max-w-container-max mx-auto px-gutter py-xl mt-10">
            <h1 class="font-display-lg text-display-lg text-on-surface mb-md">Hubungi Kami</h1>
            <div class="bg-white/70 backdrop-blur-lg border border-surface-variant rounded-xl p-md shadow-sm prose max-w-none">
                <p class="font-body-md text-body-md text-on-surface mb-4">Punya pertanyaan, saran resep, atau kendala teknis saat menggunakan BudgetBite? Kami siap membantu Anda!</p>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                    <div>
                        <h2 class="font-headline-md text-headline-md text-primary mb-4">Informasi Kontak</h2>
                        <ul class="space-y-4 font-body-md text-body-md text-on-surface">
                            <li class="flex items-center gap-3"><span class="material-symbols-outlined text-primary">email</span> support@budgetbite.id</li>
                            <li class="flex items-center gap-3"><span class="material-symbols-outlined text-primary">call</span> +62 812-3456-7890</li>
                            <li class="flex items-center gap-3"><span class="material-symbols-outlined text-primary">location_on</span> Jl. Teknologi Nusantara No. 99, Jakarta, Indonesia</li>
                        </ul>
                    </div>
                    
                    <div class="bg-surface-container-low p-6 rounded-xl border border-surface-variant">
                        <h3 class="font-headline-sm text-headline-sm text-on-surface mb-4">Kirim Pesan</h3>
                        <p class="font-label-sm text-label-sm text-on-surface-variant mb-4">Kirimkan pesan langsung ke tim kami. (Fitur ini sedang dalam pengembangan)</p>
                        <form onsubmit="event.preventDefault(); alert('Terima kasih! Pesan Anda telah kami terima.');">
                            <div class="mb-4">
                                <label class="block font-label-sm text-label-sm mb-1 text-on-surface-variant">Nama</label>
                                <input type="text" class="w-full px-4 py-2 border border-outline-variant rounded-lg bg-surface-container-lowest" required>
                            </div>
                            <div class="mb-4">
                                <label class="block font-label-sm text-label-sm mb-1 text-on-surface-variant">Email</label>
                                <input type="email" class="w-full px-4 py-2 border border-outline-variant rounded-lg bg-surface-container-lowest" required>
                            </div>
                            <div class="mb-4">
                                <label class="block font-label-sm text-label-sm mb-1 text-on-surface-variant">Pesan</label>
                                <textarea rows="3" class="w-full px-4 py-2 border border-outline-variant rounded-lg bg-surface-container-lowest" required></textarea>
                            </div>
                            <button type="submit" class="w-full bg-primary text-on-primary font-label-md py-2 rounded-lg hover:bg-primary/90 transition-colors">Kirim</button>
                        </form>
                    </div>
                </div>
            </div>
